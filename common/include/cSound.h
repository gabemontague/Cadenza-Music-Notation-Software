...
namespace AGK
{
	...
	class cSoundMgr
	{
		...
		protected:
			...
			static void PlatformCreateInstance( cSoundFile *pSound, int iVol=100, int iLoop=0, int iPriority=0 );
		...
		public:
			...
			static void PlayInstance( UINT iID, int iVol=100, int iLoop=0, int iPriority=0 );
